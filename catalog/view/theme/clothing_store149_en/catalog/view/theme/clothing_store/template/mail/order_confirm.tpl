...
<table style="font-family: Verdana,sans-serif; font-size: 11px; color: #374953; width: 600px;">
 ...
 <tr><td>&nbsp;</td></tr>
 <tr><td align="left"><?php echo $text_greeting; ?></td></tr>
 <tr><td>&nbsp;</td></tr>
 <tr>
 ...
 <tr>
  <td align="left"><?php echo $text_order_id; ?> <span style="color: #069; font-weight: bold;"><?php echo $order_id; ?></span><br />
   ...
   <?php echo $text_shipping_method; ?> <strong><?php echo $shipping_method; ?></strong><br /><br />
 ...
 <tr><td>&nbsp;</td></tr>
 <tr><td align="left" style="background-color: #069; color: #FFF; font-size: 12px; font-weight: bold; padding: 0.5em 1em;"></td></tr>
 <tr><td>&nbsp;</td></tr>
 <?php if ($comment) { ?>
 <tr>
 ...
 <tr><td>&nbsp;</td></tr>
 <tr><td align="left"><?php echo $comment; ?></td></tr>
 <tr><td>&nbsp;</td></tr>
 <?php } ?>
 <?php if ($customer_id) { ?>
 <tr>
 ...
 <tr><td>&nbsp;</td></tr>
 <tr><td align="left"><a href="<?php echo $invoice; ?>"><?php echo $invoice; ?></a></td></tr>
 <tr><td>&nbsp;</td></tr>
 <?php } ?>
 <tr>
