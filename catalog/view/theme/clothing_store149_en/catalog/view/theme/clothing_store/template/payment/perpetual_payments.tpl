...
<div id="perpetual" class="content">
 <table width="100%">
  <tr>
...
function confirmSubmit() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#perpetual').before('<div class="wait"><img src="catalog/view/theme/clothing_store/image/loading_1.gif" alt="" /> <?php echo $text_wait; ?></div>');
		},
