...
/* Add a box (mouseTrap) over the small image to trap mouse events.
		...
		*/
            ...
            $mouseTrap.bind('mouseenter', this, function (event) {
                ...
                zoomDiv = appendTo.append(format('<div id="product-zoom-big" class="product-zoom-big" style="display:none;position:absolute;left:%0px;top:-5px;width:415px;height:310px;background-image:url(\'%4\');z-index:99;"></div>', xPos, yPos, w, h, zoomImage.src)).find(':last');
