  ...
  <div class="breadcrumb">
   ...
   <h1><span><?php echo $heading_title; ?></span></h1>
    ...
    <div style="background: #F7F7F7; border: 1px solid #DDDDDD; padding: 5px 8px 10px 8px; margin-bottom: 10px;">
      <div style="text-align: center;"><img src="catalog/view/theme/fashionista/image/smile.png" width="48" height="48"></div>
    ...
    <?php } ?>
    <div style="background: #F7F7F7; border: 1px solid #DDDDDD; padding: 5px 8px 10px 8px; margin-bottom: 10px;">
      <div style="text-align: center; margin-top: 10px; margin-bottom: 20px;"><img src="catalog/view/theme/fashionista/image/tell.png" align="absmiddle" width="32" height="32" alt="" />&nbsp;<b style="font-size: larger;"><?php echo $text_tell_friends; ?></b></div>
